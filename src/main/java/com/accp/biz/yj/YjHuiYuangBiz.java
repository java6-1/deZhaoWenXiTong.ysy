...
public class YjHuiYuangBiz {
	...
	// 查询
	public HuiYuang yjSeleteHuiYuang(String phone, String huiyuanpwd) {
		return hymapper.yjSeleteHuiYuang(phone, huiyuanpwd);
	}
	...
	// 修改会员金额
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_COMMITTED, readOnly = false)
	public int updateHuiYuangManey(String jifen,String huiYuanId) {
		return hymapper.updateHuiYuangManey(jifen, huiYuanId);		
	}
	// 修改结算
		@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.READ_COMMITTED, readOnly = false)
		public int updateJiesZhuaiTai(String jiesshje,String jiesId) {
			return hymapper.updateJiesZhuaiTai(jiesshje, jiesId);	
		}
}
